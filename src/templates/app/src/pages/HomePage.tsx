    ...
    <div className={navStyles.flex}>
      ...
      <div className={styles.container}>
        ...
        <List className={styles.list}>
          <ListItem><a href="https://react-query.tanstack.com/overview" className={styles.list_link} target="_blank" >Overview</a></ListItem>
          <ListItem><a href="https://react-query.tanstack.com/installation" className={styles.list_link} target="_blank" >Installation</a></ListItem>
          <ListItem><a href="https://react-query.tanstack.com/quick-start" className={styles.list_link} target="_blank" >Quick Start</a></ListItem>
        </List>
        <Divider />
        <h2 className={styles.main_title}>Components</h2>
        <p>View few of the fusion components and read more about them <a href="https://equinor.github.io/fusion-react-components/?path=%2Fdocs%2Fintro--page%2F" target="_blank" >here</a></p>
        <div>
          <h4>Button - details <a href="https://equinor.github.io/fusion-react-components/?path=/docs/input-button--page" target="_blank" ><strong>@equinor/fusion-react-button</strong></a></h4>
        ...
        <div>
          <h4>Tooltip - details <a href="https://equinor.github.io/fusion-react-components/?path=/docs/input-tooltip--page"><strong>@equinor/fusion-react-tooltip</strong></a></h4>
          <div className={styles.ml_20}>
